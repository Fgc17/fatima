...
<Callout type="info" title="Only during development">
  `heaven.watch()` only runs stuff if you execute your app with `fatima dev`,
  otherwise it will be ignored.
</Callout>

<Callout type="warn" title="Needs to be executed">
  If your framework does not support hooks, or if for some reason you can't
  tweak the app entry file, you can't use Heaven runtime reloading.
</Callout>
